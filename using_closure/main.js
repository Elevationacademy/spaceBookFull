var SpacebookApp = function() {
    ...
    var renderPosts = function() {
        ...
        for (var i = 0; i < posts.length; i += 1) {
            ...
            $posts.append('<div class="post" data-id=' + post.id + '>' +
                ...
                post.text + getCommentsHTML(post) +
    ...
    //         var comment = _createCommentHTML(c.text, c.id);
    //         console.log("from render com:" + comment);
    //         $("[data-id=" + pid + "]").children('ul').append(comment);
    //     }
    // }
...
$('.add-post').on('click', function() {
    ...
    app.createPost(text);
    app.renderPosts();
    // var pid = $(this).closest('form').closest('div').find('.post');
    // pid = pid.attr("data-id");
});
